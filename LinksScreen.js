...
const EXTSUB4 = ["Wood", "Stucco", "Metal", "Tile", "Concrete", "Brick", "Acoustic",
  "Asphalt", "Fiberglass", "Gypsum", "Plaster", "Plastic", "Transite", "Vinyl", "Cancel"];
...
const EXTSUB8 = ["Asphalt", "Concrete", "Metal", "Wood", "Brick", "Acoustic",  "Fiberglass", "Gypsum",
  "Plaster", "Plastic", "Stucco", "Tile", "Transite", "Vinyl", "Wood", "Cancel"];

const EXTSUB9 = ['Wood', 'Metal', "Stucco", "Vinyl", "Concrete", "Brick", "Acoustic", "Asphalt",
  "Fiberglass", "Gypsum", "Plaster", "Plastic", 'Tile', "Transite", 'Cancel'];
...
const INTWAllS = ['Gypsum', 'Plaster', 'Wood', 'Tile ', 'Acoustic', 'Concrete', "Metal", 'Vinyl', "Asphalt", "Brick",
  "Fiberglass", "Plastic", "Stucco", "Tile", "Transite", 'Cancel'];
...
const INTSUB6 = ['Wood', 'Metal', 'Tile', 'Concrete', 'Acoustic',  "Asphalt",
...
const sheetButons = ["Interior Inspection Sheet", "Exterior Inspection Sheet", "Perimeter Sheet", "Soil Sample", "Dust Sample", "Layout Photo", "Property Photo", 'Cancel'];
    ...
    <View>
      ...
      <Button
        onPress={() =>
          ActionSheet.show(
            {
              options: itemPermitButons,
              cancelButtonIndex: itemPermitButons.length - 1,
              title: "Add Component"
            },
            buttonIndex => {
              for (var i = 0; i < itemPermitButons.length - 1; i++) {
                if (buttonIndex == i) {
                  props.addItemPerimeter(props.id, itemPermitButons[i])
                }
              }
            }
          )}
...
_renderPermitSheet(content, sheetId) {
            ...
            <View keyboardDismissMode="on-drag">
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.door.S || "Select Material"
                                        },
                                        buttonIndex => {
                                          if (buttonIndex != SIDES.length - 1) {
                                              content.door.S = SIDES[buttonIndex]
                                              content.frame.S = SIDES[buttonIndex]
                                              content.thresh.S = SIDES[buttonIndex]
                                              content.securitydoor.S = SIDES[buttonIndex]
                                              content.screendoor.S = SIDES[buttonIndex]
                                          }
                                          else {
                                              content.door.S= '';
                                              content.frame.S = '';
                                              content.thresh.S = '';
                                              content.securitydoor.S = '';
                                              content.screendoor.S = '';
                                          }
                                            this.setState({})
                                        }
                                    )}
                            >
                                <Text>{content.door.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                        <Button
                            onPress={() =>
                                ActionSheet.show(
                                    ...
                                    buttonIndex => {
                                        if (buttonIndex != PermSub1.length - 1) {
                                            content.door.M = PermSub1[buttonIndex]
                                            content.frame.M = PermSub1[buttonIndex]
                                            content.thresh.M = PermSub1[buttonIndex]
                                            content.securitydoor.M = PermSub1[buttonIndex]
                                            content.screendoor.M = PermSub1[buttonIndex]
                                            this.setState({})
                                        }
                                    }
                                )}
                        ...
                        <Button
                            onPress={() =>
                                ActionSheet.show(
                                    {
                                        options: PermSub1,
                                        cancelButtonIndex: PermSub1.length - 1,
                                        title: content.frame.M || "Select Material"
                                    },
                                    buttonIndex => {
                                        if (buttonIndex != PermSub1.length - 1) {
                ...
                <Col style={{ height: 200 }}>
                        ...
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.thresh.S || "Select Material"
                                        },
                                        buttonIndex => {
                                          if (buttonIndex != SIDES.length - 1) {
                                              content.thresh.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.thresh.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                        <Button
                    ...
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.securitydoor.S || "Select Material"
                                        },
                                        buttonIndex => {
                                          if (buttonIndex != SIDES.length - 1) {
                                              content.securitydoor.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.securitydoor.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                        <Button
                ...
                <Grid style={{ marginTop: 10 }}>
                    ...
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.screendoor.S || "Select Material"
                                        },
                                        buttonIndex => {
                                          if (buttonIndex != SIDES.length - 1) {
                                              content.screendoor.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.screendoor.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                        <Button
                        ...
                        <Button
                            onPress={() =>
                                ActionSheet.show(
                                    {
                                        options: PermSub2,
                                        cancelButtonIndex: PermSub2.length - 1,
                                        title: content.well.M || "Select Material"
                                    },
                                    buttonIndex => {
                                        if (buttonIndex != PermSub2.length - 1) {
                                            content.well.M = PermSub2[buttonIndex]
                                            content.sash.M = PermSub2[buttonIndex]
                                            content.frame.M = PermSub2[buttonIndex]
                                            content.shutters.M = PermSub2[buttonIndex]
                                            content.securitybars.M = PermSub2[buttonIndex]
                                            content.awning.M = PermSub2[buttonIndex]
                                            content.windowScreen.M = PermSub2[buttonIndex]
                                            this.setState({})
                                        }
                                    }
                                )}
                        ...
                        <Button
                            onPress={() =>
                                ActionSheet.show(
                                    {
                                        options: PermSub3,
                                        cancelButtonIndex: PermSub3.length - 1,
                                        title: content.wallA.M || "Select Material"
                                    },
                                    buttonIndex => {
                                        if (buttonIndex != PermSub3.length - 1) {
                                            content.wallA.M = PermSub3[buttonIndex]
                                            content.wallB.M = PermSub3[buttonIndex]
                                            content.wallC.M = PermSub3[buttonIndex]
                                            content.wallD.M = PermSub3[buttonIndex]
                                            this.setState({})
                                        }
                                    }
                                )}
                ...
                <Grid style={{ marginTop: 10 }}>
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.eaves.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.eaves.S = SIDES[buttonIndex]
                                                content.rafters.S = SIDES[buttonIndex]
                                                content.fascia.S = SIDES[buttonIndex]
                                                content.soffit.S = SIDES[buttonIndex]
                                                content.corbel.S = SIDES[buttonIndex]
                                                content.roofSup.S = SIDES[buttonIndex]
                                                content.gutter.S = SIDES[buttonIndex]
                                                content.downspout.S = SIDES[buttonIndex]
                                            } else {
                                                content.eaves.S = '';
                                                content.rafters.S = '';
                                                content.fascia.S = '';
                            ...
                            >
                                <Text>{content.eaves.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                                onPress={() =>
                                    ActionSheet.show(
                                        {
                                            options: PermSub4,
                                            cancelButtonIndex: PermSub4.length - 1,
                                            title: content.eaves.M || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != PermSub4.length - 1) {
                                                content.eaves.M = PermSub4[buttonIndex]
                                                content.rafters.M = PermSub4[buttonIndex]
                                                content.fascia.M = PermSub4[buttonIndex]
                                                content.soffit.M = PermSub4[buttonIndex]
                                                content.corbel.M = PermSub4[buttonIndex]
                                                content.roofSup.M = PermSub4[buttonIndex]
                                                content.gutter.M = PermSub4[buttonIndex]
                                                content.downspout.M = PermSub4[buttonIndex]
                                                this.setState({})
                                            }
                                        }
                                    )}
                    ...
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.rafters.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.rafters.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.rafters.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                ...
                <Grid style={{ marginTop: 10 }}>
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.fascia.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.fascia.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.fascia.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                    ...
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.soffit.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.soffit.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.soffit.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                ...
                <Grid style={{ marginTop: 10 }}>
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.gutter.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.gutter.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.gutter.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                    ...
                    <Col style={{ height: 200 }}>
                        ...
                        <Grid style={{ marginBottom: 20 }}>
                          <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.downspout.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.downspout.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.downspout.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                ...
                <Grid style={{ marginTop: 10 }}>
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                            ...
                            >
                                <Text>{content.corbel.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                    ...
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                            ...
                            >
                                <Text>{content.roofSup.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                ...
                <Grid style={{ marginTop: 10 }}>
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.cBoard.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.cBoard.S = SIDES[buttonIndex]
                                                content.trim.S = SIDES[buttonIndex]
                                                content.hTrim.S = SIDES[buttonIndex]
                                                content.vTrim.S = SIDES[buttonIndex]
                                                content.mDoor.S = SIDES[buttonIndex]
                                                content.shelf.S = SIDES[buttonIndex]
                                                content.shelfSupport.S = SIDES[buttonIndex]
                                                content.support.S = SIDES[buttonIndex]
                                            } else {
                                                content.cBoard.S = '';
                                                content.trim.S = '';
                                                content.hTrim.S = '';
                            ...
                            >
                                <Text>{content.cBoard.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                                onPress={() =>
                                    ActionSheet.show(
                                        {
                                            options: PermSub6,
                                            cancelButtonIndex: PermSub6.length - 1,
                                            title: content.cBoard.M || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != PermSub6.length - 1) {
                                                content.cBoard.M = PermSub6[buttonIndex]
                                                content.trim.M = PermSub6[buttonIndex]
                                                content.hTrim.M = PermSub6[buttonIndex]
                                                content.vTrim.M = PermSub6[buttonIndex]
                                                content.mDoor.M = PermSub6[buttonIndex]
                                                content.shelf.M = PermSub6[buttonIndex]
                                                content.shelfSupport.M = PermSub6[buttonIndex]
                                                content.support.M = PermSub6[buttonIndex]
                                                this.setState({})
                                            }
                                        }
                                    )}
                ...
                <Grid style={{ marginTop: 10 }}>
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.hTrim.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.hTrim.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.hTrim.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                    ...
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.vTrim.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.vTrim.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.vTrim.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                ...
                <Grid style={{ marginTop: 10 }}>
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.mDoor.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.mDoor.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.mDoor.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                    ...
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.shelf.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.shelf.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.shelf.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                ...
                <Grid style={{ marginTop: 10 }}>
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.shelfSupport.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.shelfSupport.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.shelfSupport.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                    ...
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.support.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.support.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.support.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                ...
                <Grid style={{ marginTop: 10 }}>
                                ...
                                onPress={() =>
                                    ActionSheet.show(
                                        ...
                                        buttonIndex => {
                                          if (buttonIndex != SIDES.length - 1) {
                                              content.door.S = SIDES[buttonIndex]
                                              content.doorframe.S = SIDES[buttonIndex]
                                          }
                                          else {
                                              content.door.S = '';
                                              content.doorframe.S = '';
                            ...
                            <Button
                                onPress={() =>
                                    ActionSheet.show(
                                        {
                                            options: PermSub5,
                                            cancelButtonIndex: PermSub5.length - 1,
                                            title: content.door.M || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != PermSub5.length - 1) {
                                                content.door.M = PermSub5[buttonIndex]
                                                content.doorframe.M = PermSub5[buttonIndex]
                                                this.setState({})
                                            }
                                        }
                                    )}
                    ...
                    <Col style={{ height: 200 }}>
                        ...
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.doorframe.S || "Select Material"
                                        },
                                        buttonIndex => {
                                          if (buttonIndex != SIDES.length - 1) {
                            ...
                            >
                                <Text>{content.doorframe.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                                    ...
                                    ActionSheet.show(
                                        ...
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                ...
                                                content.frame.S = '';
                                                content.vent.S = '';
                                                content.accessPanel.S = '';
                                                content.gate.S = '';
                                                content.fence.S = '';
                                                content.playEquip.S = '';
                                                content.planterBox.S = '';
                                                content.equipment.S = '';
                                            }
                                            this.setState({})
                                        }
                            ...
                            <Button
                                onPress={() =>
                                    ActionSheet.show(
                                        {
                                            options: PermSub7,
                                            cancelButtonIndex: PermSub7.length - 1,
                                            title: content.frame.M || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != PermSub7.length - 1) {
                                                content.frame.M = PermSub7[buttonIndex]
                                                content.vent.M = PermSub7[buttonIndex]
                                                content.accessPanel.M = PermSub7[buttonIndex]
                                                content.gate.M = PermSub7[buttonIndex]
                                                content.fence.M = PermSub7[buttonIndex]
                                                content.playEquip.M = PermSub7[buttonIndex]
                                                content.planterBox.M = PermSub7[buttonIndex]
                                                content.equipment.M = PermSub7[buttonIndex]
                                                this.setState({})
                                            }
                                        }
                                    )}
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.equipment.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.equipment.S = SIDES[buttonIndex]
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.accessPanel.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.accessPanel.S = SIDES[buttonIndex]
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.gate.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.gate.S = SIDES[buttonIndex]
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.fence.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.fence.S = SIDES[buttonIndex]
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.playEquip.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.playEquip.S = SIDES[buttonIndex]
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.planterBox.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.planterBox.S = SIDES[buttonIndex]
 ...
 if (content.title == 'Stairs') {
                ...
                <Col style={{ height: 200 }}>
                    ...
                    <Grid style={{ marginBottom: 20 }}>
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.tread.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.tread.S = SIDES[buttonIndex]
                                                content.riser.S = SIDES[buttonIndex]
                                                content.deck.S = SIDES[buttonIndex]
                                                content.handrail.S = SIDES[buttonIndex]
                                                content.railing.S = SIDES[buttonIndex]
                                                content.stringer.S = SIDES[buttonIndex]
                                                content.newel.S = SIDES[buttonIndex]
                                                content.baluster.S = SIDES[buttonIndex]
                                            } else {
                                                content.tread.S = '';
                                                content.riser.S = '';
                                                content.deck.S = '';
                            ...
                            >
                                <Text>{content.tread.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                ...
                <Col style={{ height: 200 }}>
                    ...
                    <Grid style={{ marginBottom: 20 }}>
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.riser.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.riser.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.riser.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.deck.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.deck.S = SIDES[buttonIndex]
                ...
                <Col style={{ height: 200 }}>
                    ...
                    <Grid style={{ marginBottom: 20 }}>
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.stringer.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.stringer.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.stringer.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                ...
                <Col style={{ height: 200 }}>
                    ...
                    <Grid style={{ marginBottom: 20 }}>
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.newel.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.newel.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.newel.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                ...
                <Col style={{ height: 200 }}>
                    ...
                    <Grid style={{ marginBottom: 20 }}>
                        <Col>
                                    ...
                                    ActionSheet.show(
                                        {
                                            options: SIDES,
                                            cancelButtonIndex: SIDES.length - 1,
                                            title: content.baluster.S || "Select Material"
                                        },
                                        buttonIndex => {
                                            if (buttonIndex != SIDES.length - 1) {
                                                content.baluster.S = SIDES[buttonIndex]
                            ...
                            >
                                <Text>{content.baluster.S || "Side"}</Text>
                            </Button>
                        </Col>
                        <Col>
                            <Button
                      ...
                      <Button
                          onPress={() =>
                              ActionSheet.show(
                                  {
                                      options: INTWAllS,
                                      cancelButtonIndex: INTWAllS.length - 1,
                                      title: content.wallA.M || "Select Material"
                                  },
                                  buttonIndex => {
                                      if (buttonIndex != INTWAllS.length - 1) {
                                          content.wallA.M = INTWAllS[buttonIndex]
                                          content.wallB.M = INTWAllS[buttonIndex]
                                          content.wallC.M = INTWAllS[buttonIndex]
                                          content.wallD.M = INTWAllS[buttonIndex]
                                          content.baseboard.M = INTWAllS[buttonIndex]
  
                                          content.ceiling.M = INTWAllS[buttonIndex]
                                          content.vent.M = INTWAllS[buttonIndex]
                                          content.floor.M = INTWAllS[buttonIndex]
                                          this.setState({})
                                      }
                                  }
                              )}
            ...
            <View keyboardDismissMode="on-drag">
                ...
                <Grid style={{ marginTop: 10 }}>
                    <Col style={{ height: 200 }}>
                                        ...
                                        ActionSheet.show(
                                            {
                                                options: SIDES,
                                                cancelButtonIndex: SIDES.length - 1,
                                                title: content.shelf.S || "Select Side"
                                            },
                                            buttonIndex => {
                                                if (buttonIndex != SIDES.length - 1) {
                                                    content.shelf.S = SIDES[buttonIndex]
                                ...
                                <Button
                                    onPress={() =>
                                        ActionSheet.show(
                                            ...
                                            buttonIndex => {
                                                if (buttonIndex != INTSUB6.length - 1) {
                                                    content.shelf.M = INTSUB6[buttonIndex]
                                                    this.setState({})
                                                }
                                            }
                                        )}
                        ...
                        <Text style={{ marginTop: 45 }}>{content.shelf.I == true ? 'Intact' : 'Deteriorated'}</Text>
                        <ListItem>
                            <RkChoice rkType='posNeg' selected={content.shelf.I} onChange={(e) => {
                                content.shelf.I = !content.shelf.I
                                this.setState({})
                    ...
                    <Col style={{ height: 200 }}>
                                        ...
                                        ActionSheet.show(
                                            {
                                                options: SIDES,
                                                cancelButtonIndex: SIDES.length - 1,
                                                title: content.mailSlot.S || "Select Side"
                                            },
                                            buttonIndex => {
                                                if (buttonIndex != SIDES.length - 1) {
                                                    content.mailSlot.S = SIDES[buttonIndex]
                                ...
                                <Button
                                    onPress={() =>
                                        ActionSheet.show(
                                            ...
                                            buttonIndex => {
                                                if (buttonIndex != INTSUB6.length - 1) {
                                                    content.mailSlot.M = INTSUB6[buttonIndex]
                                                    this.setState({})
                                                }
                                            }
                                        )}
                        ...
                        <Text style={{ marginTop: 45 }}>{content.mailSlot.I == true ? 'Intact' : 'Deteriorated'}</Text>
                        <ListItem>
                            <RkChoice rkType='posNeg' selected={content.mailSlot.I} onChange={(e) => {
                                content.mailSlot.I = !content.mailSlot.I
                                this.setState({})
  ...
  constructor(props) {
    ...
    this.addItemPerimeter = this.addItemPerimeter.bind(this)
    ...
    this.addPermitSheet = this.addPermitSheet.bind(this)
    ...
    this._renderPermitSheet = this._renderPermitSheet.bind(this)
      ...
      let newData = this.state.insSheets.map(x => {
        if (x.id == id) {
          x.data = [...x.data, {
            ...
            shelf: { S: null, M: null, I: true, R: null, name: 'Shelf' },
            mailSlot: { S: null, M: null, I: true, R: null, name: 'Mail Slot' },
          }],
            x.total = x.data.length - 1
        }
      })
              ...
              if (x.type == 'ExtSheet') {
                ...
                return <View style={{ padding: 10, paddingBottom: 15 }} key={x.id + 'view'}>
                  <Item key={x.id + 'item'} >
                    ...
                    focusNextField={this.focusNextField}
                    renderWindowHeader={this._renderWindowHeader}
                    renderSheet={this._renderPermitSheet} name={x.name} setName={this.setName} inputRef={this._handleRef} id={x.id} key={x.id} sheet />
                </View>
              }
              if (x.type == 'SoilSheet') {
              ...
              onPress={() =>
                ActionSheet.show(
                  ...
                  buttonIndex => {
                    ...
                    if (buttonIndex == 2) { this.addPermitSheet() }
                    if (buttonIndex == 3) { this.addSoilSheet() }
                    if (buttonIndex == 4) { this.addDustSheet() }
                    if (buttonIndex == 5) { this.getPhoto() }
                    if (buttonIndex == 6) { this.getPropertyPhoto() }
                  }
                )}
            >
