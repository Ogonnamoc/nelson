        ...
        <View>
                            ...
                            ActionSheet.show(
                                ...
                                buttonIndex => {
                                    if (buttonIndex != INTSUB2.length - 1) {
                                        ...
                                        content.heaterVent.M = INTSUB2[buttonIndex]
            ...
            <Grid>
                ...
                <Col style={{ height: 200 }}>
                    ...
                    >
                        <Text>{content.heaterVent.M || "Material"}</Text>
                    </Button>
                    <Text style={{ marginTop: 10 }}>{content.heaterVent.I == true ? 'Intact' : 'Deteriorated'}</Text>
                    <ListItem>
                        <RkChoice rkType='posNeg' selected={content.heaterVent.I} onChange={(e) => {
                            content.heaterVent.I = !content.heaterVent.I
                            this.setState({})
                        }} />
                    </ListItem>
                    <Item>
                        <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.heaterVent.R} onChangeText={(text) => {
                            let p = text.split('.').join('');
                            content.heaterVent.R = String((Math.round(p) / 10).toFixed(1));
                            this.setState({})
                        }} />
                    </Item>
                </Col>
      ...
      let newData = this.state.insSheets.map(x => {
        if (x.id == id) {
          x.data = [...x.data, {
            ...
            wallD: { S: 'D', M: null, I: true, R: null, name: 'Wall D' , item:'Wall'},
            ceiling: { S: false, M: null, I: true, R: null, name: 'Ceiling' },
            heaterVent: { S: false, M: null, I: true, R: null, name: 'Heater vent' },
            baseboard: { S: false, M: null, I: true, R: null, name: 'Baseboard' },
