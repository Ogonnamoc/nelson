 ...
 if (content.title == 'Closet') {
  return (
      <View>
          ...
          <Grid style={{marginTop:10}}>  <Col style={{ height: 200 }}>
      ...
      <View keyboardDismissMode="on-drag">
        ...
        <Grid style={{ marginTop: 10 }}>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.column.R} onChangeText={(text) => {
                  let p = text.split('.').join('');                           
                  if(p){                               content.column.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.column.R = null;                            }      
                  this.setState({})
              }} />
            </Item>
          </Col>
          ...
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.beam.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.beam.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.beam.R = null;                            }   
                   this.setState({})
                }} />
            </Item>
          </Col>
        ...
        <Grid style={{ marginTop: 10 }}>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.ceiling.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.ceiling.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.ceiling.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.floor.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.floor.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.floor.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
        ...
        <Grid style={{ marginTop: 10 }}>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.handrail.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.handrail.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.handrail.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          ...
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.railing.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.railing.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.railing.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
        ...
        <Grid style={{ marginTop: 10 }}>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.railcap.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.railcap.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.railcap.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.mailSlot.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.mailSlot.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.mailSlot.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
      ...
      <View keyboardDismissMode="on-drag">
        ...
        <Grid style={{ marginTop: 10 }}>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.well.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.well.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.well.R = null;                            }                  
                    this.setState({})
                }} />
            </Item>
          </Col>
          ...
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.sash.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.sash.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.sash.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.frame.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.frame.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.frame.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
        ...
        <Grid style={{ marginTop: 10 }}>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.shutters.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.shutters.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.shutters.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.securitybars.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.securitybars.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.securitybars.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.awning.R} onChangeText={(text) => {
                   let p = text.split('.').join('');                           if(p){                               content.awning.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.awning.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
        ...
        <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.windowScreen.R} onChangeText={(text) => {
                   let p = text.split('.').join('');                           if(p){                               content.windowScreen.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.windowScreen.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
      ...
      <View keyboardDismissMode="on-drag">
          ...
          <Grid style={{ marginTop: 10 }}>
              <Col style={{ height: 200 }}>
                  ...
                  <Item>
                      <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.cBoard.R} onChangeText={(text) => {
                           let p = text.split('.').join('');                           if(p){                               content.cBoard.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.cBoard.R = null;                            }
          ...
          <Grid style={{ marginTop: 10 }}>
              <Col style={{ height: 200 }}>
                  ...
                  <Item>
                      <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.hTrim.R} onChangeText={(text) => {
                           let p = text.split('.').join('');                           if(p){                               content.hTrim.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.hTrim.R = null;                            }
                          this.setState({})
                      }} />
                  </Item>
              </Col>
              <Col style={{ height: 200 }}>
                  ...
                  <Item>
                      <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.vTrim.R} onChangeText={(text) => {
                           let p = text.split('.').join('');                           if(p){                               content.vTrim.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.vTrim.R = null;                            }
                          this.setState({})
                      }} />
                  </Item>
              </Col>
          ...
          <Grid style={{ marginTop: 10 }}>
              <Col style={{ height: 200 }}>
                  ...
                  <Item>
                      <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.mDoor.R} onChangeText={(text) => {
                           let p = text.split('.').join('');                           if(p){                               content.mDoor.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.mDoor.R = null;                            }
                          this.setState({})
                      }} />
                  </Item>
              </Col>
              ...
              <Col style={{ height: 200 }}>
                  ...
                  <Item>
                      <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.shelf.R} onChangeText={(text) => {
                           let p = text.split('.').join('');                           if(p){                               content.shelf.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.shelf.R = null;                            }
                          this.setState({})
                      }} />
                  </Item>
              </Col>
          ...
          <Grid style={{ marginTop: 10 }}>
              <Col style={{ height: 200 }}>
                  ...
                  <Item>
                      <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.shelfSupport.R} onChangeText={(text) => {
                           let p = text.split('.').join('');                           if(p){                               content.shelfSupport.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.shelfSupport.R = null;                            }
                          this.setState({})
                      }} />
                  </Item>
              </Col>
              <Col style={{ height: 200 }}>
                  ...
                  <Item>
                      <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.support.R} onChangeText={(text) => {
                           let p = text.split('.').join('');                           if(p){                               content.support.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.support.R = null;                            }
                          this.setState({})
                      }} />
                  </Item>
              </Col>
    ...
    <View keyboardDismissMode="on-drag">
      ...
      <Grid style={{ marginTop: 10 }}>
        <Col style={{ height: 200 }}>
          ...
          <Item>
            <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.door.R} onChangeText={(text) => {
                  let p = text.split('.').join('');                           if(p){                               content.door.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.door.R = null;                            }
                 this.setState({})
              }} />
          </Item>
        </Col>
        <Col style={{ height: 200 }}>
          ...
          <Item>
            <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.doorframe.R} onChangeText={(text) => {
                  let p = text.split('.').join('');                           if(p){                               content.doorframe.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.doorframe.R = null;                            }
                 this.setState({})
              }} />
          </Item>
        </Col>
      ...
      <View keyboardDismissMode="on-drag">
        ...
        <Grid style={{ marginTop: 10 }}>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.bollard.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.bollard.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.bollard.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          ...
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.parkingStripe.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.parkingStripe.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.parkingStripe.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
        ...
        <Grid style={{ marginTop: 10 }}>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.parkingStop.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.parkingStop.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.parkingStop.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          ...
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.curb.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.curb.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.curb.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
        ...
        <Grid style={{ marginTop: 10 }}>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.lightPost.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.lightPost.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.lightPost.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          ...
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.speedBump.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.speedBump.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.speedBump.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
        ...
        <Grid style={{ marginTop: 10 }}>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.fireHydrant.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.fireHydrant.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.fireHydrant.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
    ...
    <View keyboardDismissMode="on-drag">
      ...
      <Grid style={{ marginTop: 10 }}>
        ...
        <Col style={{ height: 200 }}>
          ...
          <Item>
            <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.equipment.R} onChangeText={(text) => {
                  let p = text.split('.').join('');                           if(p){                               content.equipment.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.equipment.R = null;                            }
                 this.setState({})
              }} />
          </Item>
        </Col>
      ...
      <Grid style={{ marginTop: 10 }}>
        <Col style={{ height: 200 }}>
          ...
          <Item>
            <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.vent.R} onChangeText={(text) => {
                  let p = text.split('.').join('');                           if(p){                               content.vent.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.vent.R = null;                            }
                 this.setState({})
              }} />
          </Item>
        </Col>
        <Col style={{ height: 200 }}>
          ...
          <Item>
            <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.accessPanel.R} onChangeText={(text) => {
                  let p = text.split('.').join('');                           if(p){                               content.accessPanel.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.accessPanel.R = null;                            }
                 this.setState({})
              }} />
          </Item>
        </Col>
      ...
      <Grid style={{ marginTop: 10 }}>
        <Col style={{ height: 200 }}>
          ...
          <Item>
            <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.gate.R} onChangeText={(text) => {
                  let p = text.split('.').join('');                           if(p){                               content.gate.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.gate.R = null;                            }
                 this.setState({})
              }} />
          </Item>
        </Col>
        <Col style={{ height: 200 }}>
          ...
          <Item>
            <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.fence.R} onChangeText={(text) => {
                  let p = text.split('.').join('');                           if(p){                               content.fence.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.fence.R = null;                            }
                 this.setState({})
              }} />
          </Item>
        </Col>
      ...
      <Grid style={{ marginTop: 10 }}>
        <Col style={{ height: 200 }}>
          ...
          <Item>
            <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.playEquip.R} onChangeText={(text) => {
                  let p = text.split('.').join('');                           if(p){                               content.playEquip.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.playEquip.R = null;                            }
                 this.setState({})
              }} />
          </Item>
        </Col>
        <Col style={{ height: 200 }}>
          ...
          <Item>
            <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.planterBox.R} onChangeText={(text) => {
                  let p = text.split('.').join('');                           if(p){                               content.planterBox.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.planterBox.R = null;                            }
                 this.setState({})
              }} />
          </Item>
        </Col>
      ...
      <View keyboardDismissMode="on-drag">
        ...
        <Grid style={{ marginTop: 10 }}>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.eaves.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.eaves.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.eaves.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.rafters.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.rafters.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.rafters.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.fascia.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.fascia.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.fascia.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
        ...
        <Grid style={{ marginTop: 10 }}>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.soffit.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.soffit.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.soffit.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.gutter.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.gutter.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.gutter.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.downspout.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.downspout.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.downspout.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
        ...
        <Grid style={{ marginTop: 10 }}>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.corbel.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.corbel.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.corbel.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.roofSup.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.roofSup.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.roofSup.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
      ...
      <View keyboardDismissMode="on-drag">
        ...
        <Grid style={{ marginTop: 10 }}>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.tread.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.tread.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.tread.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          ...
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.riser.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.riser.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.riser.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          ...
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.deck.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.deck.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.deck.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
        ...
        <Grid style={{ marginTop: 10 }}>
          ...
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.stringer.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.stringer.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.stringer.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
        ...
        <Grid style={{ marginTop: 10 }}>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.newel.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.newel.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.newel.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.baluster.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.baluster.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.baluster.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
          ...
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.sill.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.sill.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.sill.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
        ...
        <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.valence.R} onChangeText={(text) => {
                    let p = text.split('.').join('');                           if(p){                               content.valence.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.valence.R = null;                            }
                   this.setState({})
                }} />
            </Item>
          </Col>
        ...
        <View keyboardDismissMode="on-drag">
            ...
            <Grid style={{ marginTop: 10 }}>
                ...
                <Col style={{ height: 200 }}>
                    ...
                    <Item>
                        <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.thresh.R} onChangeText={(text) => {
                                 let p = text.split('.').join('');                           if(p){                               content.thresh.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.thresh.R = null;                            }
                                 this.setState({})
                        }} />
                    </Item>
                </Col>
        ...
        <View keyboardDismissMode="on-drag">
            ...
            <Grid style={{ marginTop: 10 }}>
                <Col style={{ height: 200 }}>
                    ...
                    <Item>
                        <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.securityDoor.R} onChangeText={(text) => {
                             let p = text.split('.').join('');                           if(p){                               content.securityDoor.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.securityDoor.R = null;                            }
                            this.setState({})
                        }} />
                    </Item>
                </Col>
                <Col style={{ height: 200 }}>
                    ...
                    <Item>
                        <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.screenDoor.R} onChangeText={(text) => {
                             let p = text.split('.').join('');                           if(p){                               content.screenDoor.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.screenDoor.R = null;                            }
                            this.setState({})
                        }} />
                    </Item>
                </Col>
      ...
      <View>
        ...
        <Grid style={{ marginTop: 10 }}>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.wallA.R} onChangeText={(text) => {
                 let p = text.split('.').join('');                           if(p){                               content.wallA.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.wallA.R = null;                            }
                this.setState({})
              }} />
            </Item>
          </Col>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.wallB.R} onChangeText={(text) => {
                 let p = text.split('.').join('');                           if(p){                               content.wallB.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.wallB.R = null;                            }
                this.setState({})
              }} />
            </Item>
          </Col>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.wallC.R} onChangeText={(text) => {
                 let p = text.split('.').join('');                           if(p){                               content.wallC.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.wallC.R = null;                            }
                this.setState({})
              }} />
            </Item>
          </Col>
          <Col style={{ height: 190 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.wallD.R} onChangeText={(text) => {
                 let p = text.split('.').join('');                           if(p){                               content.wallD.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.wallD.R = null;                            }
                this.setState({})
              }} />
            </Item>
          </Col>
          ...
          <Col style={{ height: 209 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.baseboard.R} onChangeText={(text) => {
                 let p = text.split('.').join('');                           if(p){                               content.baseboard.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.baseboard.R = null;                            }
                this.setState({})
              }} />
            </Item>
          </Col>
  ...
  return (<View keyboardDismissMode="on-drag">
      ...
      <Grid style={{marginTop:10}}>
        <Col style={{ height: 200 }}>
           ...
           <Col style={{ height: 200 }}>
              ...
              <Item>
                  <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.countertop.R} onChangeText={(text) => {
                       let p = text.split('.').join('');                           if(p){                               content.countertop.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.countertop.R = null;                            }
                      this.setState({})
                  }} />
              </Item>
          </Col>
      ...
      <Grid style={{ marginTop: 10 }}>
          ...
          <Col style={{ height: 200 }}>
              ...
              <Item>
                  <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.backsplash.R} onChangeText={(text) => {
                       let p = text.split('.').join('');                           if(p){                               content.backsplash.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.backsplash.R = null;                            }
                      this.setState({})
                  }} />
              </Item>
          </Col>
          <Col style={{ height: 200 }}>
              ...
              <Item>
                  <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.medicine.R} onChangeText={(text) => {
                       let p = text.split('.').join('');                           if(p){                               content.medicine.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.medicine.R = null;                            }
                      this.setState({})
                  }} />
              </Item>
          </Col>
  ...
  <View>
    ...
    <Grid style={{ marginTop: 10 }}>
      <Col style={{ height: 200 }}>
        ...
        <Item>
          <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.cModling.R} onChangeText={(text) => {
     let p = text.split('.').join('');                           if(p){                               content.cModling.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.cModling.R = null;                            }
    this.setState({})
}} />
        </Item>
      </Col>
      <Col style={{ height: 200 }}>
        ...
        <Item>
          <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.picture.R} onChangeText={(text) => {
     let p = text.split('.').join('');                           if(p){                               content.picture.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.picture.R = null;                            }
    this.setState({})
}} />
        </Item>
      </Col>
    ...
    <Grid>
      <Col style={{ height: 200 }}>
        ...
        <Item>
          <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.plate.R} onChangeText={(text) => {
     let p = text.split('.').join('');                           if(p){                               content.plate.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.plate.R = null;                            }
    this.setState({})
}} />
        </Item>
      </Col>
      <Col style={{ height: 200 }}>
        ...
        <Item>
          <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.horizontal.R} onChangeText={(text) => {
     let p = text.split('.').join('');                           if(p){                               content.horizontal.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.horizontal.R = null;                            }
    this.setState({})
}} />
    ...
    <Grid style={{ marginTop: 10 }}>
      <Col style={{ height: 200 }}>
        ...
        <Item>
          <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.vertical.R} onChangeText={(text) => {
     let p = text.split('.').join('');                           if(p){                               content.vertical.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.vertical.R = null;                            }
    this.setState({})
}} />
        </Item>
      </Col>
     ...
     let p = text.split('.').join('');                           if(p){                               content.chain.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.chain.R = null;                            }
    this.setState({})
}} />
        </Item>
      </Col>
    ...
    <Grid style={{ marginTop: 10 }}>
      <Col style={{ height: 200 }}>
        ...
        <Item>
          <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.trim.R} onChangeText={(text) => {
     let p = text.split('.').join('');                           if(p){                               content.trim.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.trim.R = null;                            }
    this.setState({})
}} />
        </Item>
      </Col>
          ...
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.atticFrame.R} onChangeText={(text) => {
                 let p = text.split('.').join('');                           if(p){                               content.atticFrame.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.atticFrame.R = null;                            }
                this.setState({})
            }} />
            </Item>
          </Col>
          <Col style={{ height: 200 }}>
            ...
            <Item>
              <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.electricFrame.R} onChangeText={(text) => {
                 let p = text.split('.').join('');                           if(p){                               content.electricFrame.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.electricFrame.R = null;                            }
                this.setState({})
            }} />
            </Item>
          </Col>
    ...
    <View keyboardDismissMode="on-drag">
      ...
      <Grid style={{ marginTop: 10 }}>
        <Col style={{ height: 200 }}>
          ...
          <Item>
            <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.shower.R} onChangeText={(text) => {
       let p = text.split('.').join('');                           if(p){                               content.shower.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.shower.R = null;                            }
      this.setState({})
}} />
          </Item>
        </Col>
        ...
        <Col style={{ height: 200 }}>
          ...
          <Button block error style={{ marginLeft: 10 }}
              onPress={() =>
                ActionSheet.show(
                  ...
                  buttonIndex => {
                    if (buttonIndex != 8) {
                      content.wall.S = SIDES[buttonIndex]           
                    }else{
                      content.wall.S = null
                    }
                    this.setState({})
          ...
          <Item>
            <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.wall.R} onChangeText={(text) => {
       let p = text.split('.').join('');                           if(p){                               content.wall.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.wall.R = null;                            }
      this.setState({})
}} />
          </Item>
        </Col>
           ...
           <Button block error style={{ marginLeft: 10 }}
              onPress={() =>
                ActionSheet.show(
                  ...
                  buttonIndex => {
                    if (buttonIndex != 8) {
                      content.backsplash.S = SIDES[buttonIndex]
                      
                    }else{
                      content.backsplash.S = null
                    }
                    this.setState({})
                  }
                )}>
              <Text>{content.backsplash.S ||"Side"}</Text>
            </Button>
            </Grid>
          <Text >{content.backsplash.I == true ? 'Intact' : 'Deteriorated'}</Text>
          <ListItem>
  ...
  <View keyboardDismissMode="on-drag">
    ...
    <Grid style={{ marginTop: 10 }}>
      <Col style={{ height: 200 }}>
        ...
        <Item>
          <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.mantle.R} onChangeText={(text) => {
     let p = text.split('.').join('');                           if(p){                               content.mantle.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.mantle.R = null;                            }
    this.setState({})
}} />
        </Item>
      </Col>
      <Col style={{ height: 200 }}>
        ...
        <Item>
          <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.hearth.R} onChangeText={(text) => {
     let p = text.split('.').join('');                           if(p){                               content.hearth.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.hearth.R = null;                            }
    this.setState({})
}} />
        </Item>
      </Col>
      <Col style={{ height: 200 }}>
        ...
        <Item>
          <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.fireplace.R} onChangeText={(text) => {
     let p = text.split('.').join('');                           if(p){                               content.fireplace.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.fireplace.R = null;                            }
    this.setState({})
}} />
        </Item>
      </Col>
      <Col style={{ height: 200 }}>
        ...
        <Item>
          <Input keyboardType="numeric" placeholder="Reading" maxLength={4} value={content.chimney.R} onChangeText={(text) => {
     let p = text.split('.').join('');                           if(p){                               content.chimney.R = String((Math.round(p) / 10).toFixed(1));                            }else{                               content.chimney.R = null;                            }
    this.setState({})
}} />
        </Item>
      </Col>
      ...
      let newData = this.state.insSheets.map(x => {
        if (x.id == id) {
          x.data = [...x.data, {
            ...
            type: false,
            title: "Tile",
            shower: { M: null, I: true, R: null,S:null, name: 'Shower' },
            wall: { M: null, I: true, R: null,S:null, name: 'Wall', item:'Wall'},
            curb: { M: null, I: true, R: null,S:null, name: 'Curb' },
            ceiling: { M: null, I: true, R: null,S:null, name: 'Ceiling' },
            floor: { M: null, I: true, R: null,S:null, name: 'Floor' },
            backsplash: { M: null, I: true, R: null,S:null, name: 'Backsplash' },
            trim: { M: null, I: true, R: null,S:null, name: 'Trim' },
          }],
            x.total = x.data.length - 1
        }
      })
